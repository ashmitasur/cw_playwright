...
test.describe('Deal Document', ()=>{
    ...
    test('Add and Delete Deal Doc',async ({},testInfo)=>{
        ...
        await dealpage.addDealDoc('tests/uploadfiles/AWS Architecture - 2025.docx')     
        await expect(page.getByText('Deal attachment has been created.')).toBeVisible({timeout:20000});
        await dealpage.deleteDealDoc()
