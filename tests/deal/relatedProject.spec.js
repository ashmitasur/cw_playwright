...
test.describe('Deal Related Project', ()=>{
    ...
    test('And and Remove deal related project',async ({},testInfo)=>{
        ...
        await dealpage.addProjectToDeal();    
        await expect(page.getByText('Deal has been updated successfully.')).toBeVisible();
        await dealpage.deleteProjectFromDeal()
        await expect(page.getByText('Deal has been updated successfully.')).toBeVisible();
